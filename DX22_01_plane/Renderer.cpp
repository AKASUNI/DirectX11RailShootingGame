...
HRESULT Renderer::Init()
{
	...
	LIGHT light{};
	light.Enable = true;
	light.Direction = Vector4(0.5f, -1.f, 0.8f, 0.f);
	light.Direction.Normalize();
	light.Diffuse = Color(1.f, 1.f, 1.f, 1.f);
	light.Ambient = Color(1.f, 1.f,1.f, 1.f);
	...
	MATERIAL material{};
	material.Diffuse = Color(1.f, 1.f, 1.f, 1.f);
	material.Ambient = Color(1.f, 1.f, 1.f, 1.f);
...
{
	Matrix mat = Matrix::CreateScale(uw, vh, 1.f);
	mat *= Matrix::CreateTranslation(u, v, 0.f).Transpose();
